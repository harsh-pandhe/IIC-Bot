...
function LoginModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 backdrop-blur-sm p-4">
      <div className="bg-gradient-to-b from-[#1a2235] to-[#151c2c] p-6 rounded-2xl border border-slate-700/50 w-full max-w-sm shadow-2xl">
...
function AnalyticsModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 backdrop-blur-sm p-4">
      <div className="bg-gradient-to-b from-[#1a2235] to-[#151c2c] p-6 rounded-2xl border border-slate-700/50 w-full max-w-lg max-h-[85vh] overflow-y-auto shadow-2xl">
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1a] flex flex-col">
      ...
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 w-full py-4 px-4 border-b border-slate-800/50 bg-[#0d1321]/95 backdrop-blur-xl shadow-lg">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="relative group">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-500 via-blue-600 to-purple-600 flex items-center justify-center shadow-lg shadow-blue-500/30 group-hover:shadow-blue-500/50 transition-shadow">
          ...
          <div className="flex items-center gap-2">
            {canViewAnalytics && (
              <button
                ...
                className="px-3 py-2 text-xs bg-purple-500/10 text-purple-300 rounded-lg hover:bg-purple-500/20 border border-purple-500/20 transition-all flex items-center gap-1.5"
              >
            ...
            {messages.length > 0 && (
              <button
                ...
                className="px-3 py-2 text-xs bg-red-500/10 text-red-300 rounded-lg hover:bg-red-500/20 border border-red-500/20 transition-all flex items-center gap-1.5"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {user ? (
              <button
                ...
                className="px-3 py-2 text-xs bg-slate-700/50 text-slate-300 rounded-lg hover:bg-slate-600/50 border border-slate-600/50 transition-all"
              >
                Logout
              </button>
            ) : (
              <button
                ...
                className="px-4 py-2 text-xs bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-500 hover:to-purple-500 transition-all shadow-lg shadow-blue-500/25"
              >
                Login
              </button>
            )}
      ...
      {/* Chat Container */}
      <main className="relative flex-1 overflow-hidden flex flex-col max-w-4xl w-full mx-auto pt-20">
        <div className="flex-1 overflow-y-auto px-4 py-6 space-y-6 scrollbar-thin">
          {/* Login Required State */}
          {!user && (
            <div className="flex flex-col items-center justify-center h-full text-center py-16 animate-fadeIn">
              <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-red-500/20 to-orange-600/20 flex items-center justify-center border border-slate-700/30 mb-6 shadow-lg shadow-red-500/10">
          ...
          {user && messages.length === 0 && !loading && (
            <div className="flex flex-col items-center justify-center h-full text-center py-16 animate-fadeIn">
              <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-blue-500/20 to-purple-600/20 flex items-center justify-center border border-slate-700/30 mb-6 shadow-lg shadow-blue-500/10">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 w-full max-w-2xl">
                {SUGGESTED_QUESTIONS.map((s) => (
                  <button
                    ...
                    className="p-4 text-left bg-slate-800/30 hover:bg-slate-800/50 text-slate-300 rounded-xl border border-slate-700/30 transition-all hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/5 group"
                  >
          ...
          {messages.map((msg) => (
            ...
            >
              <div className={`flex items-start gap-3 max-w-[90%] ${msg.role === "user" ? "flex-row-reverse" : ""}`}>
                {/* Avatar */}
                <div
                  className={`w-9 h-9 rounded-xl flex-shrink-0 flex items-center justify-center shadow-lg ${msg.role === "user"
                ...
                {/* Message Content */}
                <div
                  className={`rounded-2xl overflow-hidden ${msg.role === "user"
                    ? "px-5 py-4 bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-tr-sm shadow-lg shadow-blue-500/20"
          ...
          {loading && streamingContent && (
            <div className="flex justify-start animate-fadeIn">
              <div className="flex items-start gap-3 max-w-[90%]">
                ...
                <div className="px-5 py-4 rounded-2xl rounded-tl-sm bg-[#151c2c] border border-slate-700/50 text-sm text-slate-200 leading-relaxed shadow-lg">
          ...
          {loading && !streamingContent && (
            <div className="flex justify-start animate-fadeIn">
              <div className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-lg animate-pulse">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <div className="px-5 py-4 rounded-2xl rounded-tl-sm bg-[#151c2c] border border-slate-700/50 shadow-lg">
                  <div className="flex items-center gap-2">
        ...
        {/* Input Area */}
        <div className="relative p-4 border-t border-slate-800/50 bg-[#0d1321]/80 backdrop-blur-xl">
          {/* Quick Follow-ups */}
          ...
          {/* Input */}
          <div className="flex items-center gap-3 bg-[#151c2c] rounded-2xl border border-slate-700/50 focus-within:border-blue-500/50 focus-within:ring-2 focus-within:ring-blue-500/20 transition-all shadow-lg">
            <input
              className="flex-1 px-5 py-4 bg-transparent text-white placeholder-slate-500 focus:outline-none text-sm"
              value={input}
            ...
            <button
              ...
              className="m-2 p-3 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-lg shadow-blue-500/25 disabled:shadow-none"
            >
              {loading ? (
          ...
          <p className="text-xs text-slate-600 text-center mt-3">
            {user ? `Press Enter to send • Logged in as ${user.name}` : "Please login to start chatting"}
          </p>
        </div>
      </main>
    </div>
